        ...
        <div>
            <section data-aos="zoom-in-down" data-aos-duration="3000" className="py-6 dark:bg-gray-100 dark:text-gray-900">
                <div className="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
                    <div className="flex flex-col justify-center lg:text-left">
                        ...
                        <h1 className="py-2 text-3xl font-medium leading-tight title-font">Dive into the Era of Arts and Crafts</h1>
                    </div>
            ...
            <footer className="footer p-10 bg-base-200 text-base-content">
                <aside>
                    ...
                    <p>Craftopia Ltd.<br />Providing and making reliable livings art and crafts since 1980</p>
                    <p>Craftopia Art & Craft Store <br />
                ...
                <nav>
                    ...
                    <a className="link link-hover">Craft Product Sales</a>
                    <a className="link link-hover">Customization</a>
                    <a className="link link-hover">Workshops and Classes</a>
                    <a className="link link-hover">Artisan Marketplace</a>
                    <a className="link link-hover">Artisanal Gift Boxes</a>
                </nav>
                <nav>
            ...
            <footer className="footer footer-center p-4 bg-base-200 text-base-content">
                <aside>
                    <p>Copyright © 2024 - All right reserved by Craftopia Ltd</p>
                </aside>
            </footer>
